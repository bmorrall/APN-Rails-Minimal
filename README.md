...
![Generating a certificate sign request with Keychain Access](APN-Minimal/raw/master/images/Keychain-Access-2-Generate-CSR-500x370.jpg)
...
![Exporting your private key with keychain access](APN-Minimal/raw/master/images/Keychain-Access-3-Export-Private-Key-500x279.jpg)
...
![Creating a new App ID](APN-Minimal/raw/master/images/Provisioning-1-New-AppID-500x389.jpg)
...
![List of App IDs in the iOS Provisioning Portal](APN-Minimal/raw/master/images/Provisioning-2-List-of-AppIDs-500x50.jpg)
...
![Configuring your App ID in the iOS Provisioning Portal](APN-Minimal/raw/master/images/Provisioning-3-Configure-AppID-500x350.jpg)
...
![Uploading your CSR with the SSL Assistant](APN-Minimal/raw/master/images/SSL-Assistant-1-Upload-CSR-500x453.jpg)
...
![Generating a Certificate with the SSL Assistant](APN-Minimal/raw/master/images/SSL-Assistant-2-Generating-Certificate-500x456.jpg)

It takes a few seconds to generate the SSL certificate. Click **Continue** when it’s done.

![Downloading a certificate with the SSL assistant](APN-Minimal/raw/master/images/SSL-Assistant-3-Download-Certificate-500x455.jpg)
...
![Screenshot after the SSL Assistant is Complete](APN-Minimal/raw/master/images/Provisioning-4-After-SSL-Assistant-500x111.jpg)
...
![Creating a Provisioning Profile in the iOS Provisioning Portal](APN-Minimal/raw/master/images/Provisioning-5-Create-Profile-500x293.jpg)
